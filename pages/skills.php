								...
								<div class="portlet light">
									<div class="portlet-title tabbable-line">
										<div class="caption caption-md">
											...
											<span class="caption-subject font-blue-madison bold uppercase">Skills and Languages</span>
										</div>
											...
											<div class="tab-pane active" id="tab_1_1">
												<form role="form" action="skills_update.php" method="post">
													<div class="form-group">
														<label class="control-label">Acquired Skills</label>
														<textarea placeholder="Write skills" class="form-control" name="skills"><?php echo $row['skills'];?></textarea>
													</div>
													<div class="form-group">
														<label class="control-label">Languages that you know</label>
														<textarea placeholder="Languages you know" class="form-control"  name="language"><?php echo $row['language'];?></textarea>
													</div>
