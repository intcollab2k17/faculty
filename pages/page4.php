...
?>		
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes34a;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no34a;?>> NO </td>
	</tr>
<?php
...
?>	
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes34b;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no34b;?>> NO  </td>
	</tr>
	<tr>
...
?>
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes35a;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no35a;?>> NO </td>
	</tr>
	<tr>
...
?>		
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes35b;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no35b;?>> NO </td>
	</tr>
	<tr>
...
?>
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes36;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no36;?>> NO </td>
	</tr>
	<tr>
...
?>		
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes37;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no37;?>> NO </td>
	</tr>
	<tr>
...
?>
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes38a;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no38a;?>> NO </td>
...
?>		
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes38b;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no38b;?>> NO </td>
	</tr>
	<tr>
...
?>
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes39;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no39;?>> NO </td>
...
?>		
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes40;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no40;?>> NO </td>
...
?>	
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes40a;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no40a;?>> NO </td>
	</tr>
	<tr>
...
?>	
	<tr>
		...
		<td style="width:100px"><input type="checkbox" <?php echo $yes40b;?>> YES </td>
		<td style="width:100px"><input type="checkbox" <?php echo $no40b;?>> NO </td>
	</tr>
	<tr>
...
?>	
	<tr>
		...
		<td style="width:200px"><input type="checkbox" <?php echo $yes40c;?>> YES </td>
		<td style="width:200px"><input type="checkbox" <?php echo $no40c;?>> NO </td>
	</tr>
	<tr>
