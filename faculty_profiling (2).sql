...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2017 at 10:54 PM
...
INSERT INTO `answer` (`answer_id`, `question`, `answer`, `details`, `faculty_id`, `date_filed`) VALUES
(200, '34a', 'Yes', '', 5, '0000-00-00'),
(201, '34b', 'Yes', '34b textbox', 5, '0000-00-00'),
(202, '35a', 'Yes', '35a', 5, '0000-00-00'),
(203, '35b', 'Yes', 'ddd', 5, '2015-02-01'),
(204, '36', 'Yes', '36', 5, '0000-00-00'),
(205, '37', 'Yes', '37', 5, '0000-00-00'),
(206, '38a', 'Yes', '38a', 5, '0000-00-00'),
(207, '38b', 'No', '38b', 5, '0000-00-00'),
(208, '39', 'Yes', '39', 5, '0000-00-00'),
(209, '40', 'No', '', 5, '0000-00-00'),
(210, '40a', 'Yes', '40a', 5, '0000-00-00'),
(211, '40b', 'Yes', '40b', 5, '0000-00-00'),
(212, '40c', 'No', '40c', 5, '0000-00-00');
...
(19, 5, 'Elementary', 'NA', 'Talisay Elementary School', 2008, 2014, 2015, 'NA', 'First'),
(20, 5, 'High School', 'NA', 'RBNHS', 2012, 2016, 2017, '', ''),
(21, 5, 'College', 'BSIT', 'CHMSC', 2016, 2001, 2001, 'Graduate', 'Deans List'),
(26, 5, '', 'dsds', 'dsd', 2017, 2017, 2018, 'ds', 'dsds'),
(27, 5, '', 'dd', 'dd', 2, 2019, 2020, ',kjkj', 'dd'),
...
INSERT INTO `faculty` (`faculty_id`, `faculty_last`, `faculty_first`, `faculty_middle`, `faculty_ext`, `faculty_pic`, `password`, `gender`, `civil`, `height`, `weight`, `res_address`, `res_zip`, `res_tel`, `perm_address`, `perm_zip`, `perm_tel`, `email`, `bday`, `contact`, `pob`, `citizenship`, `sss`, `tin`, `philhealth`, `gsis`, `pagibig`, `emp_no`, `blood_type`, `reg_date`, `language`, `skills`, `status`, `inactive`, `last_update`, `dept_id`) VALUES
(5, 'Jungco', 'Christy ', 'Torres', '', 'default.gif', '123', 'Female', 'Single', '154', '45', 'Brgy Busay Bago City', 6101, 'na', 'Brgy Busay Bago City', 6101, 'na', 'crissy@gmail.com', '1996-10-14', '639177736230', 'Bacolod City', 'Filipino', '323', '3232', '3232', '3232', '332323', '', 'B', '2017-07-12', '', '', 1, 'Active', '2017-07-10', 1),
(7, 'Torres', 'Delilah', '', '', 'default.gif', '123', 'Female', 'Single', '2.3', '45', 'Brgy. Banago, Bacolod City', 6100, 'na', 'Brgy. Banago, Bacolod City', 6100, 'na', 'torres@yahoo.com', '1990-10-14', '639177736230', 'Silay City', 'Filipino', '123', '456', '789', '012', '234', '', 'A', '2017-09-02', '', '', 1, 'Active', '2017-09-05', 2),
(8, 'dada', 'dada', '', '', 'default.gif', '123', '', '', '', '', '', 0, '', '', 0, '', 'emoblazz@gmail.com1', '2017-01-01', '', '', '', '', '', '', '', '', '', '', '2017-09-05', '', '', 0, '', '0000-00-00', 1);
...
--
ALTER TABLE `answer`
  MODIFY `answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=213;
--
